...
class SignupStep4EmailVerifyScreen extends StatefulWidget {
  const SignupStep4EmailVerifyScreen({super.key});

  @override
  State<SignupStep4EmailVerifyScreen> createState() => _SignupStep4EmailVerifyScreenState();
}

class _SignupStep4EmailVerifyScreenState extends State<SignupStep4EmailVerifyScreen> {
