...
class FindIDStep1EmailVerifyScreen extends StatefulWidget {
  const FindIDStep1EmailVerifyScreen({super.key});

  @override
  State<FindIDStep1EmailVerifyScreen> createState() => _FindIDStep1EmailVerifyScreenState();
}

class _FindIDStep1EmailVerifyScreenState extends State<FindIDStep1EmailVerifyScreen> {
  ...
  void _verifyCode() {
    Navigator.pushNamed(context, '/auth_edit/FindID/step2');
  }
